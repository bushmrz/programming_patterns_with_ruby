...
class Student < StudentBase
  ...
  public :phone, :telegram, :mail, 'id=', 'phone=', 'telegram=', 'mail=', 'git='
  ...
  def to_s
    ...
    %i[id phone telegram mail git].each do |attr|
      attr_val = send(attr)
  ...
  def to_hash
    attrs = {}
    %i[last_name first_name father_name id phone telegram mail git].each do |attr|
      attr_val = send(attr)
